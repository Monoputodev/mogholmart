                        								...
                        								<table style="border-collapse: collapse;mso-table-lspace: 0pt;mso-table-rspace: 0pt;" align="left" border="0" cellpadding="0" cellspacing="0" width="100%">
                        									<tbody>
                        										<!-- <tr>
                        											image 540x200
                        											<td align="center">
                        												<a href="http://zinismart.com.bd" class="modimg" style="color:#8e44ad;">
                        													<img src="http://zinismart.com.bd/logo/zinismart.png" alt="" style="width:100%;outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;border: none;display:block;" class="banner">
                        												</a>
                        											</td>
                        										</tr> -->
                        										<!-- image 540x200 -->
                        										<tr style="">
                        											<td class="text" style="font-family: 'Poppins', sans-serif; color:#383838; font-weight:400; line-height:26px; font-size: 14px; text-decoration:none; padding:66px 20px 68px; background: #dbffd2">
                        												<div class="rocket-txt">
                        													...
                        													<span style="display: block; padding-bottom: 10px " class="wrap_textbox">You have successfully created a Zinis-Mart Merchant Account. Please click on the link below to verify your email address and complete the registration</span>
                        													...
                        													margin: auto;" href="{{URL::to('merchant/confirm-email')}}/{{$user_data->remember_token}}"> Please Verified Your Email</a></span>

                        													<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Don't Create Zinis-Mart Merchant account?? It's likely someone just type in your email address by accident . Feel free to ignore this account.</span>
