				...
				<div class="input-group">
					...
					<div class="col-md-2 col-sm-2" >
						<div class="form-line">
							...
							{!! Form::text('order_no',@Input::get('order_no')? Input::get('order_no') : null,['class' => 'form-control','placeholder'=>'Type order number']) !!}
					...
					<div class="col-md-2 col-sm-2" >
						<div class="form-line">
							...
							{!! Form::Select('status',$order_status,Input::old('status'),['id'=>'status', 'class'=>'form-control select2class']) !!}
					...
					<div class="col-md-2 col-sm-2" >
						<div class="form-line">
							...
							{!! Form::Select('payment_type',$payment_status,Input::old('payment_type'),['id'=>'payment_type', 'class'=>'form-control ','placeholder'=>'Payment type']) !!}
								...
								<td>
									@if ($values->payment_type=="cod" && $values->status=="delivered")
										...
										@elseif($values->payment_type=="foster_payment" && $values->status !="pending")
											...
											@if ($values->relTransection->order_head_id==$values->id)
