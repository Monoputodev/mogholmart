				...
				<div class="input-group">
					...
					<div class="col-md-2 col-sm-2" >
						<div class="form-line">
							...
							{!! Form::Select('merchant_id',$merchant_list,@Input::get('merchant_id')? Input::get('merchant_id') : Input::old('merchant_id'),['id'=>'merchant_id', 'class'=>'form-control select2class']) !!}
						</div>
					</div>
					<div class="col-md-2 col-sm-2" >
						<div class="form-line">
							<label>Filter by order status:</label>
							{!! Form::Select('status',$order_status,@Input::get('status')? Input::get('status') : Input::old('status'),['id'=>'status', 'class'=>'form-control select2class','placeholder'=>'Select status']) !!}
