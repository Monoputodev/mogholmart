...
<div class="row clearfix">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			{!! Form::model($product_category,['method' => 'PATCH', 'files'=> true, 'route'=> ['admin.product.category.update',$data->id],"class"=>"", 'id' => 'category_form']) !!}

				@include('Product::product._category_form')
