...
<div class="row clearfix">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			{!! Form::model($inventory_data,['method' => 'PATCH', 'files'=> true, 'route'=> ['admin.product.inventory.update',$data->id],"class"=>"", 'id' => 'inventoryform']) !!}

			@include('Product::product.productInventory._inventory_form')
