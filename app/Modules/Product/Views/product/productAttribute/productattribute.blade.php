...
<div class="block-header block-header-2">
    ...
    <a  style="margin-left: 10px;" href="{{ route('admin.product.active') }}" class="btn btn-info waves-effect pull-right">Active Product</a>
...
<div class="row clearfix">
	...
	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
		<div class="card">
			...
			{!! Form::model($attributes,['method' => 'PATCH', 'files'=> true, 'route'=> ['admin.product.attribute.update',$data->id],"class"=>"", 'id' => 'attribute_form']) !!}

			@include('Product::product.productAttribute._productattribute_form')
