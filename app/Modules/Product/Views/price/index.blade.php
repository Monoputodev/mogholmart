            ...
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="body">
                            <div class="row clearfix">
                                <form action="{{ route('admin.price.update.category') }}" method="GET">
                                    {{ csrf_field()}}
                                <div class="col-md-3">
                                    <p>
                                        <b>Search With Category</b>
                                    </p>
                                    <select name="product_category" id="product_category" class="form-control show-tick" data-live-search="true" required="true">
                                @foreach ($category as $element)
                                <?php
                                    $total_product = DB::table('product')->join('product_category', 'product_category.product_id', '=', 'product.id')
                                    ->where('product_category.category_id',$element->id)
                                ...
                                ?>
                                    <option value="{{$element->id}}"
                                        @php
                                        if(isset($form_data['category_id']) && ($element['id'] == $form_data['category_id']))
                                          echo "selected";
                                      @endphp
                                    >{{$element->title .' ('.count($total_product).')'}}</option>
                                @endforeach
                                    </select>
                                </div>
