			...
			<div class="col-12">
				<div class="bread-inner">
					<ul class="bread-list">
						...
						<li>Search Data<i class="ti-arrow-right"></i></li>
				...
				<div class="shop-top">
					<div class="shop-shorter">
						<div class="single-shorter">
							<h4 class="widget-title"><span style="color: red">{{$total_product}}</span> results for <span style="color: red">{{$pageTitle}}</span></h4>
						</div>
					</div>
				</div>
			</div>
