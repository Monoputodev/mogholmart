      ...
      <div class="col-12">
        <div class="bread-inner">
          <ul class="bread-list">
            ...
            <li><a href="{{route('category.slug',['slug' => $main_category_data->category_slug])}}">{{$main_category_data->category_title}} <i class="ti-arrow-right"></i></a></li>
            <li class="active">{{$category_data->category_title}}</li>
          </ul>
