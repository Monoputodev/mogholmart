...
<a href="{{config('global.DOMAIN_NAME')}}"><img src="{{config('global.DOMAIN_NAME')}}/uploads/generel_file/logo.png" style="height: 100px;" alt="img"></a>
	...
	<tr style="">
		<td class="text" style="font-family: 'Poppins', sans-serif; color:#383838; font-weight:400; line-height:26px; font-size: 14px; text-decoration:none; padding:66px 20px 68px; background: #dbffd2">
			<div class="rocket-txt">
				...
				<span style="display: block; padding-bottom: 10px " class="wrap_textbox">You have successfully created a account. Please click on the link below to verify your email address and complete the registration</span>
				...
				margin: auto;" href="{{URL::to('pb/confirm/email')}}/{{$user_data->remember_token}}"> Please Verify Your Email</a></span>

				<span style="display: block; padding-bottom: 10px " class="wrap_textbox">Don't Create account?? It's likely someone else just type in your email address by accident . Feel free to ignore this account.</span>
